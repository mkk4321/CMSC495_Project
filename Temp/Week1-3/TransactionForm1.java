 ...
 * @author Manoj
 */
 public class TransactionForm1 extends javax.swing.JFrame {
    ...
    public void UpcChanged() {
        ...
        transTable.setValueAt("AAAA", rw, 3);
        System.out.println("changed");
    }
    public void UnitsChanged() {
        int rw = transTable.getSelectedRow();
        int cl = transTable.getSelectedColumn();
        transTable.setValueAt(33, rw, 9);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransactionForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransactionForm1().setVisible(true);
            }
        });
    }
